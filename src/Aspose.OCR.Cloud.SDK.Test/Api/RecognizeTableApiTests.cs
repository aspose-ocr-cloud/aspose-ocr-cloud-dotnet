...
{
    /// <summary>
    ///  Class for testing RecognizeTableApi
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class RecognizeTableApiTests
    {
        private RecognizeTableApi instance;
        ...
        public void Init()
        {
            ...
            {
                instance = new RecognizeTableApi(Config.TargetClientId, Config.TargetClientSecret);
            }
            else
            {
                ...
                instance = new RecognizeTableApi(config);
            }
        }
        ...
        /// <summary>
        /// Test GetRecognizeTable
        /// </summary>
        [Test]
        [TestCaseSource("GetArgsForGetRecognizeTable")]
        public void GetRecognizeTableTest(string testCaseName, string id, bool saveFile = false, string expectedResult = "Success")
        {
            try
            {
                var response = instance.GetRecognizeTable(id);
        ...
        public static IEnumerable<object[]> GetArgsForGetRecognizeTable()
        {
        ...
        /// <summary>
        /// Test PostRecognizeTable
        /// </summary>
        [Test]
        [TestCaseSource("GetArgsForPostRecognizeTable")]
        public void PostRecognizeTableTest(string testCaseName, PostRecognizeTableTestSettings testCase)
        {
            ...
            OCRRecognizeTableBody body = new OCRRecognizeTableBody(testCase.Image, settings);

            var response = instance.PostRecognizeTable(body);
            Assert.IsInstanceOf<string>(response, "response is string");
            Console.WriteLine($"Task ID: {response}");
            Thread.Sleep((int)(testCase.WaitTime * 1000));
            GetRecognizeTableTest(response, response);
        }

        public static IEnumerable<object[]> GetArgsForPostRecognizeTable()
        {
            yield return new object[]
            {
                "simple English PNG",
                new PostRecognizeTableTestSettings()
                {
        ...
        /// </summary>
        public struct PostRecognizeTableTestSettings
        {
            public byte[] Image;
            ...
            public PostRecognizeTableTestSettings(
                byte[] image,
