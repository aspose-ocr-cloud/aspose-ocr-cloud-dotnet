...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsRecognizeRegions")]
    public partial class OCRSettingsRecognizeRegions : IEquatable<OCRSettingsRecognizeRegions>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsRecognizeRegions" /> class.
        /// </summary>
        ...
        public OCRSettingsRecognizeRegions(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeUpsampling = false, List<OCRRegion> regions = default(List<OCRRegion>), ResultType? resultType = default(ResultType?), bool makeBinarization = true, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?))
        {
        ...
        {
            return this.Equals(input as OCRSettingsRecognizeRegions);
        }

        /// <summary>
        /// Returns true if OCRSettingsRecognizeRegions instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsRecognizeRegions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsRecognizeRegions input)
        {
            if (input == null)
            {
                return false;
