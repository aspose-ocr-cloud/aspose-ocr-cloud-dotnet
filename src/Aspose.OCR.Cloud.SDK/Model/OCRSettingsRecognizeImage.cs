...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsRecognizeImage")]
    public partial class OCRSettingsRecognizeImage : IEquatable<OCRSettingsRecognizeImage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsRecognizeImage" /> class.
        /// </summary>
        ...
        public OCRSettingsRecognizeImage(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeBinarization = false, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsRecognizeImage {\n");
        ...
        {
            return this.Equals(input as OCRSettingsRecognizeImage);
        }

        /// <summary>
        /// Returns true if OCRSettingsRecognizeImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsRecognizeImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsRecognizeImage input)
        {
            if (input == null)
            {
                return false;
