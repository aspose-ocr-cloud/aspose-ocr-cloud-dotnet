...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRRecognizeReceiptBody : IEquatable<OCRRecognizeReceiptBody>, IValidatableObject
    {
        ...
        protected OCRRecognizeReceiptBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRRecognizeReceiptBody" /> class.
        /// </summary>
        /// <param name="image">Gets or Sets Image (required).</param>
        /// <param name="settings">settings (required).</param>
        public OCRRecognizeReceiptBody(byte[] image = default(byte[]), OCRSettingsRecognizeReceipt settings = default(OCRSettingsRecognizeReceipt))
        {
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for OCRRecognizeReceiptBody and cannot be null");
            }
            this.Image = image;
            // to ensure "settings" is required (not null)
            if (settings == null)
            {
                throw new ArgumentNullException("settings is a required property for OCRRecognizeReceiptBody and cannot be null");
            }
        ...
        public OCRSettingsRecognizeReceipt Settings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRRecognizeReceiptBody {\n");
