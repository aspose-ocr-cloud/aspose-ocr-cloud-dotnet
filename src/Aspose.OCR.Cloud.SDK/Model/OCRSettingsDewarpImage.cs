...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsDewarpImage")]
    public partial class OCRSettingsDewarpImage : IEquatable<OCRSettingsDewarpImage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsDewarpImage" /> class.
        /// </summary>
        ...
        public OCRSettingsDewarpImage(Pipeline pipeline = default(Pipeline), ResultType? resultType = default(ResultType?), Language? language = default(Language?), int rotate = default(int), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsDewarpImage {\n");
        ...
        {
            return this.Equals(input as OCRSettingsDewarpImage);
        }

        /// <summary>
        /// Returns true if OCRSettingsDewarpImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsDewarpImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsDewarpImage input)
        {
            if (input == null)
            {
                return false;
