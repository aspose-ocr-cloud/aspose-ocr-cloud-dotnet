...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRSettingsRecognizeReceipt : IEquatable<OCRSettingsRecognizeReceipt>, IValidatableObject
    {
        ...
        public OCRSettingsRecognizeReceipt(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, int rotate = default(int), bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
