...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsRecognizeReceipt")]
    public partial class OCRSettingsRecognizeReceipt : IEquatable<OCRSettingsRecognizeReceipt>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsRecognizeReceipt" /> class.
        /// </summary>
        ...
        public OCRSettingsRecognizeReceipt(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        {
            return this.Equals(input as OCRSettingsRecognizeReceipt);
        }

        /// <summary>
        /// Returns true if OCRSettingsRecognizeReceipt instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsRecognizeReceipt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsRecognizeReceipt input)
        {
            if (input == null)
            {
                return false;
