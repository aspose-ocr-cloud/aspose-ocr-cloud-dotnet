...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsProcessImage")]
    public partial class OCRSettingsProcessImage : IEquatable<OCRSettingsProcessImage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsProcessImage" /> class.
        /// </summary>
        ...
        public OCRSettingsProcessImage(ResultType? resultType = default(ResultType?), Pipeline pipeline = default(Pipeline), Language? language = default(Language?), int rotate = default(int), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsProcessImage {\n");
        ...
        {
            return this.Equals(input as OCRSettingsProcessImage);
        }

        /// <summary>
        /// Returns true if OCRSettingsProcessImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsProcessImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsProcessImage input)
        {
            if (input == null)
            {
                return false;
