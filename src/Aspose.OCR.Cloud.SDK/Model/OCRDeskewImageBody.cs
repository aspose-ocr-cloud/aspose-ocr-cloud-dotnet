...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRDeskewImageBody : IEquatable<OCRDeskewImageBody>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OCRDeskewImageBody);
        }

        /// <summary>
        /// Returns true if OCRDeskewImageBody instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRDeskewImageBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRDeskewImageBody input)
        {
            if (input == null)
            {
                return false;
