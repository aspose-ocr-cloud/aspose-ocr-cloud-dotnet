...
{
    /// <summary>
    /// PostRecognizeImageRequest
    /// </summary>
    [DataContract(Name = "PostRecognizeImage_request")]
    public partial class PostRecognizeImageRequest : IEquatable<PostRecognizeImageRequest>, IValidatableObject
    {
        ...
        public OCRTaskPriority? Priority { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRecognizeImageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostRecognizeImageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRecognizeImageRequest" /> class.
        /// </summary>
        ...
        public PostRecognizeImageRequest(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), Pipeline pipeline = default(Pipeline), OCRTaskPriority? priority = default(OCRTaskPriority?), bool makeBinarization = true, ResultTypeTable? resultTypeTable = default(ResultTypeTable?), System.IO.Stream image = default(System.IO.Stream))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostRecognizeImageRequest {\n");
        ...
        {
            return this.Equals(input as PostRecognizeImageRequest);
        }

        /// <summary>
        /// Returns true if PostRecognizeImageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRecognizeImageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRecognizeImageRequest input)
        {
            if (input == null)
            {
                return false;
