...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsRecognizePdf")]
    public partial class OCRSettingsRecognizePdf : IEquatable<OCRSettingsRecognizePdf>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsRecognizePdf" /> class.
        /// </summary>
        ...
        public OCRSettingsRecognizePdf(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), bool makeBinarization = true, bool makeUpsampling = false, ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsRecognizePdf {\n");
        ...
        {
            return this.Equals(input as OCRSettingsRecognizePdf);
        }

        /// <summary>
        /// Returns true if OCRSettingsRecognizePdf instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsRecognizePdf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsRecognizePdf input)
        {
            if (input == null)
            {
                return false;
