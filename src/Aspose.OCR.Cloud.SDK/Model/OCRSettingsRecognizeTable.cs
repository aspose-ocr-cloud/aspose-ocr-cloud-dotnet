...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRSettingsRecognizeTable : IEquatable<OCRSettingsRecognizeTable>, IValidatableObject
    {
        ...
        public OCRSettingsRecognizeTable(Language? language = default(Language?), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, ResultTypeTable? resultTypeTable = default(ResultTypeTable?), bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        {
            return this.Equals(input as OCRSettingsRecognizeTable);
        }

        /// <summary>
        /// Returns true if OCRSettingsRecognizeTable instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsRecognizeTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsRecognizeTable input)
        {
            if (input == null)
            {
                return false;
