...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsBinarizeImage")]
    public partial class OCRSettingsBinarizeImage : IEquatable<OCRSettingsBinarizeImage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsBinarizeImage" /> class.
        /// </summary>
        ...
        public OCRSettingsBinarizeImage(Pipeline pipeline = default(Pipeline), ResultType? resultType = default(ResultType?), Language? language = default(Language?), int rotate = default(int), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsBinarizeImage {\n");
        ...
        {
            return this.Equals(input as OCRSettingsBinarizeImage);
        }

        /// <summary>
        /// Returns true if OCRSettingsBinarizeImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsBinarizeImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsBinarizeImage input)
        {
            if (input == null)
            {
                return false;
