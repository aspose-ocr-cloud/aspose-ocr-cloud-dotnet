...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OCRSettingsUpscaleImage")]
    public partial class OCRSettingsUpscaleImage : IEquatable<OCRSettingsUpscaleImage>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRSettingsUpscaleImage" /> class.
        /// </summary>
        ...
        public OCRSettingsUpscaleImage(Pipeline pipeline = default(Pipeline), ResultType? resultType = default(ResultType?), Language? language = default(Language?), int rotate = default(int), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = true, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCRSettingsUpscaleImage {\n");
        ...
        {
            return this.Equals(input as OCRSettingsUpscaleImage);
        }

        /// <summary>
        /// Returns true if OCRSettingsUpscaleImage instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRSettingsUpscaleImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRSettingsUpscaleImage input)
        {
            if (input == null)
            {
                return false;
