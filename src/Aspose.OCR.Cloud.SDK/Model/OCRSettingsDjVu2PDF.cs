...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRSettingsDjVu2PDF : IEquatable<OCRSettingsDjVu2PDF>, IValidatableObject
    {
        ...
        public OCRSettingsDjVu2PDF(Language? language = default(Language?), int rotate = default(int), bool makeSkewCorrect = true, bool makeSpellCheck = false, bool makeContrastCorrection = false, bool makeBinarization = true, bool makeUpsampling = false, DsrMode? dsrMode = default(DsrMode?), DsrConfidence? dsrConfidence = default(DsrConfidence?), ResultType? resultType = default(ResultType?), ResultTypeTable? resultTypeTable = default(ResultTypeTable?), List<OCRRegion> regions = default(List<OCRRegion>))
        {
