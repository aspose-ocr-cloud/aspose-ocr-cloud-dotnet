...
namespace Aspose.OCR.Cloud.SDK.Model
{
    ...
    public partial class OCRResponse : IEquatable<OCRResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OCRResponse);
        }

        /// <summary>
        /// Returns true if OCRResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of OCRResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRResponse input)
        {
            if (input == null)
            {
                return false;
