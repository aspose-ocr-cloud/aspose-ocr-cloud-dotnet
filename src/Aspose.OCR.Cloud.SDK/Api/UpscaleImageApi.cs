...
namespace Aspose.OCR.Cloud.SDK.Api
{
    ...
    /// </summary>
    public interface IUpscaleImageApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUpscaleImageApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IUpscaleImageApi : IUpscaleImageApiSync, IUpscaleImageApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class UpscaleImageApi : IUpscaleImageApi
    {
        ...
        public UpscaleImageApi(string client_id, string client_secret)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpscaleImageApi"/> class
        /// using Configuration object
        /// </summary>
        /// <param name="configuration">An instance of Configuration</param>
        /// <returns></returns>
        public UpscaleImageApi(Aspose.OCR.Cloud.SDK.Client.Configuration configuration)
        {
        ...
        public UpscaleImageApi(Aspose.OCR.Cloud.SDK.Client.ISynchronousClient client, Aspose.OCR.Cloud.SDK.Client.IAsynchronousClient asyncClient, Aspose.OCR.Cloud.SDK.Client.IReadableConfiguration configuration)
        {
        ...
        public Aspose.OCR.Cloud.SDK.Client.ApiResponse<Object> CancelUpscaleImageWithHttpInfo(string id, int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new Aspose.OCR.Cloud.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling UpscaleImageApi->CancelUpscaleImage");
            }
            ...
            localVarRequestOptions.Operation = "UpscaleImageApi.CancelUpscaleImage";
            ...
            var localVarResponse = this.Client.Delete<Object>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CancelUpscaleImage", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Aspose.OCR.Cloud.SDK.Client.ApiResponse<Object>> CancelUpscaleImageWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<Object>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Aspose.OCR.Cloud.SDK.Client.ApiResponse<OCRResponse> localVarResponse = GetUpscaleImageWithHttpInfo(id);
        ...
        public Aspose.OCR.Cloud.SDK.Client.ApiResponse<OCRResponse> GetUpscaleImageWithHttpInfo(string id, int operationIndex = 0)
        {
            ...
            if (id == null)
            {
                throw new Aspose.OCR.Cloud.SDK.Client.ApiException(400, "Missing required parameter 'id' when calling UpscaleImageApi->GetUpscaleImage");
            }
            ...
            localVarRequestOptions.Operation = "UpscaleImageApi.GetUpscaleImage";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<OCRResponse>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUpscaleImage", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Aspose.OCR.Cloud.SDK.Client.ApiResponse<OCRResponse>> GetUpscaleImageWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<OCRResponse>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Aspose.OCR.Cloud.SDK.Client.ApiResponse<string> localVarResponse = PostUpscaleImageWithHttpInfo(oCRUpscaleImageBody);
            return localVarResponse.Data;
        }
        ...
        public Aspose.OCR.Cloud.SDK.Client.ApiResponse<string> PostUpscaleImageWithHttpInfo(OCRUpscaleImageBody oCRUpscaleImageBody, int operationIndex = 0)
        {
            ...
            {
                throw new Aspose.OCR.Cloud.SDK.Client.ApiException(400, "Missing required parameter 'oCRUpscaleImageBody' when calling UpscaleImageApi->PostUpscaleImage");
            }
            ...
            localVarRequestOptions.Data = oCRUpscaleImageBody;

            localVarRequestOptions.Operation = "UpscaleImageApi.PostUpscaleImage";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<string>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostUpscaleImage", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Aspose.OCR.Cloud.SDK.Client.ApiResponse<string>> PostUpscaleImageWithHttpInfoAsync(OCRUpscaleImageBody oCRUpscaleImageBody, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<string>(GetAdjustedPath("./v5/UpscaleImage"), localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
