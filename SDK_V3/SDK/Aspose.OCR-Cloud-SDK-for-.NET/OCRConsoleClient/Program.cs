...
namespace OCRConsoleClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IOcrV3Api ocrApiV3 = new OcrV3Api(APIKEY, APPSID, BASEPATH);
            ...
            Debug.Assert("OK" == ocrResponseV1.Status);
            ...
            Debug.Assert("OK" == ocrResponseV2.Status);
            Console.WriteLine($"OCRV2 Text:{ocrResponseV2.Text}");

            Console.WriteLine($"{Environment.NewLine}{new string('=', Console.WindowWidth - 1)}{Environment.NewLine}");

            Console.WriteLine($"Recognizing {name} with OCRV3...");
            OCRResponse ocrResponseV3 = ocrApiV3.OcrV3GetRecognizeDocument(name, null, null);
            Debug.Assert("OK" == ocrResponseV3.Status);
            Console.WriteLine($"OCRV3 Text:{ocrResponseV3.Text}");
