...
namespace OCRTest
{
    ...
    public class TestOcrApi
    {
        ...
        /// <summary>
        ///A test for GetRecognizeDocument using OCloud.OCR V1
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///A test for GetRecognizeDocumentCloud using OCloud.OCR V2
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///A test for GetRecognizeDocumentCloud using OCloud.OCR V3
        ///</summary>
        [TestMethod()]
        public void V3_TestGetRecognizeDocument()
        {
            OcrV3Api target = new OcrV3Api(APIKEY, APPSID, BASEPATH);
            StorageApi storageApi = new StorageApi(APIKEY, APPSID, BASEPATH);

            string name = "quick_fox.png";
            ...
            Com.Aspose.Ocr.Model.OCRResponse actual;
            actual = target.OcrV3GetRecognizeDocument(name, storage, folder);

            Assert.AreEqual("OK", actual.Status);
            Assert.IsInstanceOfType(new OCRResponse(), actual.GetType());
            Assert.AreEqual(expected, actual.Text.Trim());
        }

        /// <summary>
        ///A test for PostOcrFromUrlOrContent using OCloud.OCR V1
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///A test for PostOcrFromUrlOrContent using OCloud.OCR V2
        ///</summary>
        [TestMethod()]
        ...
        /// <summary>
        ///A test for PostOcrFromUrlOrContent using OCloud.OCR V3
        ///</summary>
        [TestMethod()]
        public void V3_TestPostOcrFromUrlOrContent()
        {
            OcrV3Api target = new OcrV3Api(APIKEY, APPSID, BASEPATH);
            ...
            Com.Aspose.Ocr.Model.OCRResponse actual;
            actual = target.OcrV3PostOcrFromUrlOrContent(url, file);
