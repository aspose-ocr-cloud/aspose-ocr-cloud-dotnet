...
using Aspose.OCR.Cloud.Live.Demos.UI.Controllers;
...
namespace Aspose.OCR.Cloud.Live.Demos.UI.Models
{
	public class LandingPageModel
	{
		...
		public AsposeOCRCloudContext AsposeOCRCloudContext
		{
			get
			{
				if (_atcContext == null) _atcContext = new AsposeOCRCloudContext(HttpContext.Current);
				return _atcContext;
			}
		}
		...
		public string UIBasePath => Configuration.AsposeOCRCloudLiveDemosPath;
