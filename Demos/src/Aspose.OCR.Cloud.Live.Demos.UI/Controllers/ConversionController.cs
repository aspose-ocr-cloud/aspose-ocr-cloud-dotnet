		...
		public Response Conversion(string outputType)
		{
			...
			foreach (string fileName in Request.Files)
			{
				...
				if (postedFile != null)
				{
					...
					{
						AsposeOCRConversion asposeOCRConversion = new AsposeOCRConversion();
							 response = asposeOCRConversion.Convert(isFileUploaded.FileName, isFileUploaded.FolderId,   outputType.ToLower().Replace(" ", ""));
