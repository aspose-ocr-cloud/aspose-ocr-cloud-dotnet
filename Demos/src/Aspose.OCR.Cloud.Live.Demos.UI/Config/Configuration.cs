...
namespace Aspose.OCR.Cloud.Live.Demos.UI.Config
{
	public static class Configuration
	{
		...
		private static string _asposeOCRCloudLiveDemosPath = ConfigurationManager.AppSettings["AsposeOCRCloudLiveDemosPath"].ToString();
		private static string _resourceFileSessionName = ConfigurationManager.AppSettings["ResourceFileSessionName"];
		private static string _asposeOCRCloudAppsAssetURL = ConfigurationManager.AppSettings["AsposeOCRCloudAppsAssetURL"];
		...
		public static string AsposeOCRCloudLiveDemosPath
		{
			get { return _asposeOCRCloudLiveDemosPath; }
		}
		...
		public static string AsposeOCRCloudAppsAssetURL
		{
			get { return _asposeOCRCloudAppsAssetURL; }
		}
