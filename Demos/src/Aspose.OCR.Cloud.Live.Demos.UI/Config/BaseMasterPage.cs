...
namespace Aspose.OCR.Cloud.Live.Demos.UI.Config
{
    ...
    {
        private AsposeOCRCloudContext _atContext;
        ...
        public AsposeOCRCloudContext AsposeOCRCloudContext
        {
            get
            {
                if (_atContext == null) _atContext = new AsposeOCRCloudContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
            ...
            AsposeOCRCloudContext.atcc = AsposeOCRCloudContext;
            base.OnLoad(e);
        }
    }
}
